...
urlpatterns = [
    ...
    path("patients/<uuid:pk>/chronic-programs", patient_views.patient_chronic_programs),
    path("patients/<uuid:pk>/family-links", patient_views.patient_family_links),
    ...
    path("records/immunisation", record_views.create_immunisation),
    path("records/procedure-note", record_views.create_procedure_note),
    path("records/notifiable-disease", record_views.create_notifiable_disease),
    ...
    path("admin/equipment", admin_views.hospital_equipment),
    ...
    path("billing/nhis/eligibility", billing_views.check_nhis_eligibility),
    path("billing/dashboard", billing_views.billing_dashboard),
    path("billing/invoices/new", billing_views.create_invoice),
    ...
    path("billing/invoices/<uuid:invoice_id>/nhis-status", billing_views.get_nhis_claim_status),
    path("patients/<uuid:patient_id>/billing-history", billing_views.patient_billing_history),
    path("health/smtp-test", health_views.test_smtp),
    ...
    path("fhir/MedicationRequest", fhir_views.fhir_medication_request_list_create),
    path("fhir/MedicationRequest/<uuid:pk>", fhir_views.fhir_medication_request_read),
    path("fhir/Observation", fhir_views.fhir_observation_list_create),
    ...
    path("global-patients/accessible/", global_patient_views.accessible_patients),
    ...
    path("referrals/outgoing", referral_views.referral_outgoing),
    path("referrals/mine", referral_views.my_referrals),
    path("referrals/<uuid:pk>", referral_views.referral_update),
    path("referrals/<uuid:pk>/accept", referral_views.accept_referral),
    path("referrals/<uuid:pk>/complete", referral_views.complete_referral),
