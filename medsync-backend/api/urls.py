...
urlpatterns = [
    ...
    path("auth/set-device-pin", auth_views.set_device_pin),
    path("auth/session-unlock", auth_views.session_unlock),
    ...
    path("nhis/status", billing_views.nhis_integration_status),
